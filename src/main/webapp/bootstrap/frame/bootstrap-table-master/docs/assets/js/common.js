$(function () {
    ...
    // examples
    $('#examples').load('/wenzhixin/bootstrap2-table/issues/1765 #issue-119870991 .comment-body', function () {
        var $this = $(this);
...
function methodFormatter(value) {
    ...
    var href = 'http://issues.wenzhixin.net.cn/bootstrap2-table/#methods/' + value + '.html';
